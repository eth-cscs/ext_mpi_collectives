...
#define OPCODE_SET_SOCKETBARRIER 7
#define OPCODE_WAIT_SOCKETBARRIER 8
#define OPCODE_NEXT_SOCKETBARRIER 9
#define OPCODE_SET_MEM 10
#define OPCODE_UNSET_MEM 11
#define OPCODE_REDUCE 12
#define OPCODE_MPISENDRECV 13
#define OPCODE_MPISEND 14
#define OPCODE_MPIRECV 15
#define OPCODE_LOCALMEM 16
#define OPCODE_MPIWAITANY 17
#define OPCODE_ATTACHED 18
#define OPCODE_REDUCE_WAIT 19
#ifdef GPU_ENABLED
#define OPCODE_GPUSYNCHRONIZE 20
#define OPCODE_GPUKERNEL 21
#endif
#ifdef NCCL_ENABLED
#define OPCODE_START 22
#endif
