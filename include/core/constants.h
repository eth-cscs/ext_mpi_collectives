...
#define OPCODE_BSOCKETBARRIER 5
#define OPCODE_SOCKETBARRIER 6
#define OPCODE_NODEBARRIER 7
#define OPCODE_SET_SOCKETBARRIER 8
#define OPCODE_WAIT_SOCKETBARRIER 9
#define OPCODE_NEXT_SOCKETBARRIER 10
#define OPCODE_CYCL_SOCKETBARRIER 11
#define OPCODE_SET_MEM 12
#define OPCODE_UNSET_MEM 13
