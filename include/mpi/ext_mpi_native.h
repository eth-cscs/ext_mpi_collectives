...
int EXT_MPI_Reduce_scatter_init_native(
    ...
    int *groups, int num_active_ports, int copyin, int *copyin_factors, int alt, int recursive, int blocking, int num_sockets_per_node, int shmem_zero, char *locmem, int *padding_factor);
