...
./average.sh Grace_Hopper_hpe_mpi/santis_gpu_4nodes_16tasks_hpe_mpi_*.txt > Grace_Hopper_4nodes_16tasks_hpe_mpi.txt
./average.sh Grace_Hopper_ext_mpi/santis_gpu_4nodes_16tasks_ext_mpi_a_*.txt > Grace_Hopper_4nodes_16tasks_ext_mpi_a.txt
./average.sh Grace_Hopper_ext_mpi/santis_gpu_4nodes_16tasks_ext_mpi_b_*.txt > Grace_Hopper_4nodes_16tasks_ext_mpi_b.txt
./minimum.sh Grace_Hopper_4nodes_16tasks_ext_mpi_?.txt > Grace_Hopper_4nodes_16tasks_ext_mpi.txt
